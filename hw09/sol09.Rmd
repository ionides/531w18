...
We start with loading the data and reproduce the results in the notes12.
...
bsflu_data <- read.table("http://ionides.github.io/531w18/12/bsflu_data.txt")
...
bsflu_params <- data.matrix(read.table("http://ionides.github.io/531w18/12/mif_bsflu_params.csv",row.names=NULL,header=TRUE))
...
Comparing this result with the one from the notes12, we can see this method actually does not help much in finding sharp peaks, although it has scale invariant property.
