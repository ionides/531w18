...
4. [Linear time series models and the algebra of ARMA models](notes04/notes04.html). [(R script)](notes04/notes04.R)
...
* [Homework 1](hw01/hw01.html), due in class on 1/17. 

<!-- [Solution](hw/sol01.html).>

<!--

* [Homework 2](hw02/hw02.html), due in class on 1/26. [Solution](hw/sol02.html).

* [Homework 3](hw03/hw03.html), due midnight on 2/2. [Solution](hw/sol03.html). See also [Chapter 7.3](http://ionides.github.io/531w18/notes7/notes7.html#some-data-analysis-using-the-frequency-domain).
...
* You're welcome to browse previous midterm projects [available online](http://ionides.github.io/531w16/midterm_project/)
